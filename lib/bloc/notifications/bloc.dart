...
class NotificationBloc extends Bloc<NotificationEvent,NotificationState>{
  ...
  NotificationBloc(NotificationRepository notificationRepository) : super(UnInitializedState()){
    ...
    on<FetchNotificationData>((event, emit) async {
      ...
      try {
        ...
        List<NotificationData> notifications = await notificationRepository.getNotifications();
